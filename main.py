...
__CHANNEL_USERNAME__ = "Cpmalex channel"
__GROUP_USERNAME__ = "cpmalex chat"
...
　　　　⠉⠓⠢⠤⠤⠤⠔⠊⠁⠀⠀⠀⠀⠀⠀ 
    ...
    console.print("\t\t\t        [bold green]♕ CPMCane♕[/bold green]")
    ...
    console.print("   [bold][yellow]   Get in touch with me to buy an unlimited balance[bold][yellow][green][bold] Telegram:-@CANECPM[/green][/bold]", end="\n\n")
